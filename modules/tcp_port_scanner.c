...
int process_packet(unsigned char* , int, int* ports);
unsigned short csum(unsigned short * , int );
char * hostname_to_ip(char * );
int get_local_ip (char *);
void addToArray(int arr[], int number);
...
void portScanner(char* target, int* ports)
{
	...
	int arr_port[35] = {66,80,81,443,445,457,1080,1100,1241,1352,1433,1434,1521,1944,2301,3000,3128,3306,4000,
						4001,4002,4100,5000,5432,5800,5801,5802,6346,6347,7001,7002,8080,8443,8888,30821};
	...
	if( pthread_create( &sniffer_thread , NULL ,  receive_ack , ports) < 0)
	{
...
int start_sniffer(int* ports)
{
	...
	while(start<endwait)
	{
		...
		int port = process_packet(buffer , data_size, ports);
		start = time(NULL);
...
int process_packet(unsigned char* buffer, int size, int* ports)
{
